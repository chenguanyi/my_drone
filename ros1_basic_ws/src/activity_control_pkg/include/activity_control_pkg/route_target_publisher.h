...
public:
  ...
  //路径规划
  void startsnakepath(int map_size, double square_length, double altitude);//蛇形路径
  void startplanpath(int num,int map_size_x,int map_size_y,double square_length,double altitude);//规划矩形路径
  void Pathplan_24Race();//24电赛路径规划
  void Pathplan_24Race2();// 测试版
  void PathTest();//调pid用的
  void zixuanTest();// 测试自旋
private:
